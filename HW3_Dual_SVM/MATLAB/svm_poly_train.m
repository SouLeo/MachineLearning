...
function [support_vecs, conv, w, b] = svm_poly_train(train_img_col, svm_labels_c, max_iter, d, C)
    conv = 0;
    ...
    for i = 1:max_iter
        ...
        for j = 1:n_samples
            ...
            k_ij = Poly_Kernel(x_ind, x_ind, d) + ...
                Poly_Kernel(x_j, x_j, d) - ...
                2*Poly_Kernel(x_ind, x_j, d); 
